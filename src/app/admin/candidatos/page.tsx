    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
      ...
      <div className="mb-6 flex flex-wrap items-center gap-2">
        ...
        <button
          ...
          className="ml-auto flex items-center gap-2 rounded-full bg-green-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-green-700 transition-colors"
        >
