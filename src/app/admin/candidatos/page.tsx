        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={() => {
              ...
              window.location.href = `/api/admin/candidatos/export?${params}`;
            }}
            className="flex items-center gap-2 rounded-lg bg-green-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-green-700 transition-colors whitespace-nowrap"
          >
